...
class VoIPExtensionMapping(Base):
    """Maps a CRM user to a provider extension without storing PBX credentials."""
    __tablename__ = "voip_extension_mappings"
    __table_args__ = (
        UniqueConstraint("provider", "user_id", name="uq_voip_mapping_provider_user"),
        UniqueConstraint("provider", "extension_number", name="uq_voip_mapping_provider_extension"),
    )
